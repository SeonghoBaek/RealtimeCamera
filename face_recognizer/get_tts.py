...
name_list = ['BaekSeongho', 'HyunDaewon', 'JangYoonseok', 'KimDaeseoung', 'KimMina', 'KimHwiyoung',
...
sentences_A = ['좋은 아침이에요', '커피 한 잔 하세요', '좋은 하루 되세요', '더 웃으세요', '들어와요', '화이팅!', '멋지시네요',
               ...
               '제 이름은 뭘까요?', '어서와요', '요즘 책 좀 보시나요?', '어떤 조언도 길게 하지는 마세요', '배움은 재산이랍니다.', '오 멋져요', '보고싶었어요',
               '사랑해요', '동안이네요',
               '하이', '마할로', '알로하', '왔어요?', '자주 보네요', '축하해요. 뭔지 모르지만.', '좋은 일 생길거에요.', '부자 되세요', '좋아 보이네요',
               '침입자다. 힛 농담이에요.', '밥은 먹고 다니세요?', '반갑구만', '반가반가', '복 받으세요', '오세요', '복권 사보세요', '너무 반가워요', '전 드루와에요',
               '기억할께요']
...
sentences_B = ['산뜻한 오후 보내세요', '화이팅 하세요', '운동 좀 하세요', '힘드시죠? 힘내세요', '당신은 자랑스러운 사람입니다',
               ...
               '긍정적인 마인드', '하이', '마할로', '알로하', '왔어요?', '자주 보네요', '축하해요. 뭔지 모르지만.', '좋은 일 생길거에요.',
               '부자 되세요', '좋아 보이네요', '침입자다. 힛 농담이에요.', '밥은 먹고 다니세요?', '반갑구만', '반가반가', '복 받으세요', '오세요',
               '헬로', '그리웠어요', '전 드루와에요', '잘 기억해둘께요']

sentences_C = ['점심 드셨나요', '어서와요', '스마일', '오셨어요?', '멋집니다', '하이', '마할로', '알로하', '왔어요?'
               , '자주 보네요', '축하해요. 뭔지 모르지만.', '좋은 일 생길거에요.', '부자 되세요', '좋아 보이네요', '침입자다. 힛 농담이에요.',
               '밥은 먹고 다니세요?', '반갑구만', '반가반가', '복 받으세요',
               '부자 되세요', '좋아 보이네요', '침입자다. 힛 농담이에요.', '밥은 먹고 다니세요?', '반갑구만요', '반가반가', '복 받으세요', '오세요',
               '스마일']

sentences_D = ['곧 즐거운 퇴근이에요', '하이', '마할로', '알로하', '왔어요?', '자주 보네요', '축하해요. 뭔지 모르지만.', '좋은 일 생길거에요.', '부자 되세요'
               , '좋아 보이네요', '침입자다. 힛 농담이에요.', '밥은 먹고 다니세요?', '반갑구만', '반가반가', '복 받으세요', '오세요']

sentences_E = ['어서 퇴근하셔야죠', '하이', '마할로', '알로하', '왔어요?', '자주 보네요', '축하해요. 뭔지 모르지만.', '좋은 일 생길거에요.', '부자 되세요'
               , '좋아 보이네요', '침입자다. 힛 농담이에요.', '밥은 먹고 다니세요?', '반갑구만', '반가반가', '복 받으세요', '오세요']
